...
@invoices_blueprint.route('/invoice/create-emb=<embedded>', methods=['GET', 'POST'])
@login_required
...
@invoices_blueprint.route('/invoice/pay', methods=['GET', 'POST'])
@login_required
def payInvoice():
...
@invoices_blueprint.route('/invoice/reject', methods=['GET', 'POST'])
@login_required
def rejectInvoice():
...
@invoices_blueprint.route('/invoice/remove', methods=['GET', 'POST'])
@login_required
def removeInvoice():
	print("invoice")
...
@invoices_blueprint.route('/invoice/change<invoice>', methods=['GET', 'POST'])
@login_required
...
@invoices_blueprint.route('/invoices/renderpdf/<inv>')
@login_required
def renderpdf(inv):
...
@invoices_blueprint.route('/invoices/email/<inv>')
@login_required
