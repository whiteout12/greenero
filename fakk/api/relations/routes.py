...
@relations_api.route('/relations/request', methods=['GET', 'POST'])
@login_required
def friendrequest():
	#from fakk import db
...
@relations_api.route('/relations/accept', methods=['GET', 'POST'])
@login_required
...
@relations_api.route('/relations/reject', methods=['GET', 'POST'])
@login_required
...
@relations_api.route('/relations/withdraw', methods=['GET', 'POST'])
@login_required
...
@relations_api.route('/relations/unfriend', methods=['GET', 'POST'])
@login_required
def unfriend():
	#from models import User, Relationship
	if request.method == 'POST':
...
@relations_api.route('/relations/getrelations')
@login_required
def relations():
	#from models import User
